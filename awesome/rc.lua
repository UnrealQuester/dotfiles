...
-- awful.util.spawn_with_shell("compton --config ~/.comption.conf &")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "s", function () awful.util.spawn("i3lock -i " .. os.getenv("HOME") .. "/wallpapers/wallpaper.png -t") end),
    ...
    awful.key({ modkey }, "Up",    function () awful.util.spawn("amixer set Master 1%+") end),
    awful.key({ modkey }, "Down",    function () awful.util.spawn("amixer set Master 1%-") end),
